      ...
      var list = this.state.songs.map(function (song, i) {
        _this3.state.alphabet.map(function (letter, i) {
          if (song.fields[letter]) {
            song.fields[letter].content[0].content.map(function (song, i) {
              if (song.content) {
                song.content.map(function (song, i) {
                  song.content.map(function (song, i) {
                    return __jsx("div", {
...
//# sourceMappingURL=list.js.4d56d1f486cddeaa5f55.hot-update.js.map